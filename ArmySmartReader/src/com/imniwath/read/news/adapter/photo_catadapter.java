...
public class photo_catadapter extends BaseAdapter {
	private LayoutInflater mInflater;
	private int mItemHeight = 0;
	private int mNumColumns = 0;
	private RelativeLayout.LayoutParams mImageViewLayoutParams;
	private Context context;
	private static ArrayList<photocat_bean> items;
    
	DisplayImageOptions options;
	protected ImageLoader imageLoader = ImageLoader.getInstance();
	public photo_catadapter(Context context) {
		this.context=context;
		items = new ArrayList<photocat_bean>();
	...
	public void additem(photocat_bean bean) {
		items.add(bean);
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		Log.e("debug", "holder.imageView" +holder.imageView.getHeight()) ;
		 photocat_bean itemlist = items.get(position);
