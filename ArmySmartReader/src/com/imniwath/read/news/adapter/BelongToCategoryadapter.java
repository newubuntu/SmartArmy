...
public class BelongToCategoryadapter extends BaseAdapter {
	private LayoutInflater mInflater;
	private int mItemHeight = 0;
	private int mNumColumns = 0;
	private RelativeLayout.LayoutParams mImageViewLayoutParams;
	private Context context;
	private static ArrayList<BelongToCategory_Bean> items;
    
	DisplayImageOptions options;
	protected ImageLoader imageLoader = ImageLoader.getInstance();
	public BelongToCategoryadapter(Context context) {
		this.context=context;
		items = new ArrayList<BelongToCategory_Bean>();
	...
	public void additem(BelongToCategory_Bean bean) {
		items.add(bean);
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		BelongToCategory_Bean itemlist = items.get(position);
	   imageLoader.displayImage(itemlist.getLogo(), holder.imageView,
		...
		String summary = itemlist.getUnitname();
